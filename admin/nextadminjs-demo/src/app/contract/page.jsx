  ...
  return (
    <div className="min-h-screen bg-background py-10 px-4 flex justify-center">
      <div className="bg-background  rounded-2xl shadow-2xl max-w-2xl w-full p-6">
        <h1 className="text-center text-title font-titles md:text-2xl mb-6 uppercase">
          Contrato de Alquiler de Puesto en Mercaduca
        </h1>

        <div className="mb-6 font-info">
          <h2 className="font-semibold mb-2 text-title">Información del cliente:</h2>
        ...
        <div className="mb-6 font-info">
          <h2 className="font-semibold mb-2 text-title">Duración del contrato:</h2>
          <p className="mb-2 text-foreground">
            De acuerdo a las políticas de Mercaduca, el período de participación en el local emprendedor es de tres meses
          </p>
          <p className="mb-2 text-foreground"><strong>Estado actual:</strong> {contract.status || "Pendiente"}</p>
          <p className="mb-2 text-foreground"><strong>Fecha de inicio:</strong> {contract.startDate || "DD/MM/YY"}</p>
          <p className="mb-2 text-foreground"><strong>Fecha de fin:</strong> {contract.endDate || "DD/MM/YY"}</p>
        </div>

        <div className="mb-6 font-info">
          <h2 className="font-semibold text-title mb-2">Monto y forma de pago:</h2>
          <p className=" text-foreground mb-2 "><strong>Frecuencia de pago:</strong> {contract.kindOfPayment || "Mensual"}</p>
          <p className=" text-foreground mb-2"><strong>Método de pago:</strong> {contract.paymentMethod || "Efectivo"}</p>
        </div>

        <div className="mb-6 font-info">
          <h2 className="font-semibold text-title mb-2 ">Causales de terminación:</h2>
